...
import { AlertTriangle, Twitter, CheckCircle, XCircle, ExternalLink } from 'lucide-react';
...
const TestTweetButton: React.FC<TestTweetButtonProps> = ({
  ...
  const [tweetContent, setTweetContent] = useState("Just set up my DevShare automation! Now my coding activity will be shared automatically.");
